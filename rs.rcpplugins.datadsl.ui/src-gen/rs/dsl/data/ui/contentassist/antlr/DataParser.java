...
* generated by Xtext
*/
package rs.dsl.data.ui.contentassist.antlr;
...
public class DataParser extends AbstractContentAssistParser {
	...
	@Override
	protected rs.dsl.data.ui.contentassist.antlr.internal.InternalDataParser createParser() {
		rs.dsl.data.ui.contentassist.antlr.internal.InternalDataParser result = new rs.dsl.data.ui.contentassist.antlr.internal.InternalDataParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFactoryDefinitionAccess().getGroup(), "rule__FactoryDefinition__Group__0");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			rs.dsl.data.ui.contentassist.antlr.internal.InternalDataParser typedParser = (rs.dsl.data.ui.contentassist.antlr.internal.InternalDataParser) parser;
